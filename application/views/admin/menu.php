...
<div class="container">
	<div id="menu">
		<ul class="nav nav-tabs">
			...
			<li class="<?php if($active=='mahasiswa')echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/adminController/viewMahasiswa">siswa</a></li>
			<li class="<?php if($active=='dosen')echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/adminController/viewDosen">guru</a></li>
			<li class="<?php if($active=='matakuliah')echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/adminController/viewMatakuliah">Mata pelajaran</a></li>
